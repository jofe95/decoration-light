; File:     decoration-light\main.asm
; Device:   ATtiny412
...
.include "macros.asm"
.include "irrxpd-cfg.asm"
.include "irrxpd-defs.asm"
.list
...
.include "irrc-panasonic-n2qayb.asm"
...
.include "irrxpd-init.asm"
; == Initialize TCA (isr100us) ==
